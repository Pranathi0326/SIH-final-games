...
## Workflow
1. Clone the repository or open in your preferred IDE.
2. Install dependencies with `npm i`.
3. Start the development server using `npm run dev`.
4. Access the website locally or via the provided URL.
5. Students and teachers can log in using demo credentials below.
6. Explore games, assignments, and features as per your role.
